...
class OrganSlotMaskedAutoencoderViT(OWT_models.MaskedAutoencoderViT):
    def __init__(
        ...
        if slot_head_type in ("arm_f_attention", "arm_f_linear", "arm_f_query_dot", "arm_f_reverse_dot", "arm_f_reverse_dot_p2") and pixel_pe != "none":
        ...
        if slot_head_type in ("arm_f_attention", "arm_f_linear", "arm_f_query_dot", "arm_f_reverse_dot", "arm_f_reverse_dot_p2"):
            ...
            if decode_heads:
                ...
                if active_head_rows.numel():
                    if slot.head_type in (
                        ...
                        "arm_f_attention", "arm_f_linear", "arm_f_query_dot", "arm_f_reverse_dot", "arm_f_reverse_dot_p2", "arm_e_multiscale_query_3d",
                    ):
                        if (
    ...
    def forward(
        ...
        if decode_heads and self.pixel_query_decoder is not None:
            if self._slot_factory["head_type"] in ("arm_e_multiscale_query", "arm_f_attention", "arm_f_linear", "arm_f_query_dot", "arm_f_reverse_dot", "arm_f_reverse_dot_p2", "arm_e_multiscale_query_3d"):
