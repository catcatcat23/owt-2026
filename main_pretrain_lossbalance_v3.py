...
def get_args_parser():
    ...
    parser.add_argument('--roi_frequency_alpha', type=float, default=0.5,
                        help='frequency exponent: 0 equal occurrences, 1 inverse frequency')
    parser.add_argument('--roi_max_weight_ratio', type=float, default=4.0,
                        help='maximum foreground frequency-weight ratio')
...
def main(args):
    ...
    if args.num_classes == 1:
        ...
        print('ROI positive sample counts:', args.roi_positive_sample_counts)
        print('ROI class weights [background, foreground...]:',
              args.roi_class_weights)
...
if __name__ == '__main__':
    ...
    if args.roi_max_weight_ratio < 1.0:
        raise ValueError('--roi_max_weight_ratio must be at least 1')
    if args.roi_positive_sample_counts is not None and min(args.roi_positive_sample_counts) <= 0:
        raise ValueError('--roi_positive_sample_counts must all be positive')
