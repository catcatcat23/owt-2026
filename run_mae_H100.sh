...
CLS=(',' '0' '0,2,3,4' '0,1,3,4' '0,1,2,4' '0,1,2,3')
for id_index_train in {0..500..10}
do
for topk in {3..7..2} ## top3, top5, top7
do
for cls_i in {0..5..1}
do
CUDA_VISIBLE_DEVICES=${GPU} python vis_OWC2_LIB_3D_retrieval.py --model ${MODEL_NAME} --mask_ratio 1.0 --input_size 224 --arch_version ${ARCH_Ver} --num_classes ${CLASSES} --token_factor ${TOKEN_Fac} --training_version ${TRAIN_Ver} --loss_version ${LOSS_Ver} --output_vis ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/ --checkpoint ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/checkpoint-${ckpt}.pth --reverse 0 --load_data_vis_path ${TRAIN_DATA_PATH} --load_label_vis_path ${TRAIN_LABL_PATH} --load_csv_type train --save_video 1 --select_cls ${CLS[${cls_i}]} --topk ${topk} --id_index ${id_index_train} >> ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/generate_in_step4/train/${id_index_train}.txt
# CUDA_VISIBLE_DEVICES=${GPU} python vis_OWC2_LIB_3D_retrieval.py --model ${MODEL_NAME} --mask_ratio 1.0 --input_size 224 --arch_version ${ARCH_Ver} --num_classes ${CLASSES} --token_factor ${TOKEN_Fac} --training_version ${TRAIN_Ver} --loss_version ${LOSS_Ver} --output_vis ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/ --checkpoint ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/checkpoint-${ckpt}.pth --reverse 0 --load_data_vis_path ${TEST_DATA_PATH} --load_label_vis_path ${TEST_LABL_PATH} --load_csv_type test --save_video 1 --select_cls ${CLS[${cls_i}]} --topk ${topk} --id_index ${id_index_test} >> ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/generate_in_step4/test/${id_index_test}.txt
done
done
done
...
GPU=7
ckpt=1199
# CUDA_VISIBLE_DEVICES=${GPU} python vis_OWC2_LIB_2D_gen_fix.py --model ${MODEL_NAME} --mask_ratio 1.0 --input_size 224 --arch_version ${ARCH_Ver} --num_classes ${CLASSES} --token_factor ${TOKEN_Fac} --training_version ${TRAIN_Ver} --loss_version ${LOSS_Ver} --output_vis ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/ --checkpoint ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/checkpoint-${ckpt}.pth --reverse 0 --load_data_vis_path ${TRAIN_DATA_PATH} --load_label_vis_path ${TRAIN_LABL_PATH} --load_csv_type train --save_video 1 --select_cls '' > ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/eval_gen_train_epoch${ckpt}_cls''.txt
CUDA_VISIBLE_DEVICES=${GPU} python vis_OWC2_LIB_2D_gen_fix.py --model ${MODEL_NAME} --mask_ratio 1.0 --input_size 224 --arch_version ${ARCH_Ver} --num_classes ${CLASSES} --token_factor ${TOKEN_Fac} --training_version ${TRAIN_Ver} --loss_version ${LOSS_Ver} --output_vis ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/ --checkpoint ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/checkpoint-${ckpt}.pth --reverse 0 --load_data_vis_path ${TEST_DATA_PATH} --load_label_vis_path ${TEST_LABL_PATH} --load_csv_type test --save_video 1 --select_cls '' > ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/eval_gen_test_epoch${ckpt}_cls''.txt
...
do
for topk in {3..3..2} ## top3, top5, top7
do
for cls_i in {1..1..1}
do
# CUDA_VISIBLE_DEVICES=${GPU} python vis_OWC2_LIB_2D_retrieval.py --model ${MODEL_NAME} --mask_ratio 1.0 --input_size 224 --arch_version ${ARCH_Ver} --num_classes ${CLASSES} --token_factor ${TOKEN_Fac} --training_version ${TRAIN_Ver} --loss_version ${LOSS_Ver} --output_vis ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/ --checkpoint ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/checkpoint-${ckpt}.pth --reverse 0 --load_data_vis_path ${TRAIN_DATA_PATH} --load_label_vis_path ${TRAIN_LABL_PATH} --load_csv_type train --save_video 1 --select_cls ${CLS[${cls_i}]} --topk ${topk} --id_index ${id_index_train} >> ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/generate_in_step4/train/${id_index_train}.txt
CUDA_VISIBLE_DEVICES=${GPU} python vis_OWC2_LIB_2D_retrieval.py --model ${MODEL_NAME} --mask_ratio 1.0 --input_size 224 --arch_version ${ARCH_Ver} --num_classes ${CLASSES} --token_factor ${TOKEN_Fac} --training_version ${TRAIN_Ver} --loss_version ${LOSS_Ver} --output_vis ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/ --checkpoint ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/checkpoint-${ckpt}.pth --reverse 0 --load_data_vis_path ${TEST_DATA_PATH} --load_label_vis_path ${TEST_LABL_PATH} --load_csv_type test --save_video 1 --select_cls ${CLS[${cls_i}]} --topk ${topk} --id_index ${id_index_test} #>> ${RESULT_PATH}/${CUR_PATH}/${PROCESS_NAME}/vis/generate_in_step4/test/${id_index_test}.txt
done
done
done
