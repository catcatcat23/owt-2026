...
case "$DIMENSION" in
  2D) export MICRO_BATCH=2 ACCUM_ITER=24 TARGET_EFFECTIVE_BATCH=192 SAVE_FREQ=100 ;;
  3D) export MICRO_BATCH=1 ACCUM_ITER=12 TARGET_EFFECTIVE_BATCH=48 SAVE_FREQ=10 FIX_FRAME=4 TEMP_STRIDE=1 ;;
  *) exit 2 ;;
esac
