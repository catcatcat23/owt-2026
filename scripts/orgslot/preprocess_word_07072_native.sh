...
cd "${REPO_ROOT}"
"${PYTHON}" tools/preprocess_common8_112_448.py   --dataset WORD   --source-root "${SOURCE_ROOT}"   --split-json "${SPLIT_JSON}"   --output-root "${OUTPUT_ROOT}"   --spacing 0.7 0.7 2   --runtime-input-size 448   --manifest-tag native07072   --hu-clip -175 250   --image-order 3   --jpeg-quality 95
