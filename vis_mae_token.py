...
def save_tensor(x, save_name, mask = False):
...
def gen_one_image(input_img, model):
    ...
    if args.training_version == 'v0':
        ...
        middle1 = {"image_target": x, "random_selected_class": random_selected_class}
...
if __name__ == '__main__':
    ...
    label2 = path+'Test/mask/BDMAP_00000068/BDMAP_00000068_81.png'
